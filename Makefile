...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/alsa-lib/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILES := \
...
SRC_URLS := $(addprefix https://www.alsa-project.org/files/pub/lib/,$(SRC_FILES))
